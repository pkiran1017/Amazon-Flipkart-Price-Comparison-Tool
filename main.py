...
class Price_compare:
    ...
    def __init__(self, master):
        ...
        label = Label(master, text='Design By Kiran Pandit')
        label.grid(row=2, column=0, padx=(10, 8), pady=4)
    ...
    def find(self):
        ...
        label_name = Label(self.window, text='Design By Kiran Pandit')
        label_name.grid(row=5, column=1, padx=(10, 8), pady=4)
